...
export function Navbar() {
  ...
  return (
    <>
      ...
      {/* Mobile Menu Overlay — rendered as a sibling to header, outside its stacking context */}
      <div
        className={cn(
          "fixed inset-0 top-16 bg-background md:hidden overflow-y-auto z-40",
          "transition-opacity duration-300 ease-in-out",
          isOpen ? "opacity-100 pointer-events-auto" : "opacity-0 pointer-events-none"
        )}
      >
        <div className="flex flex-col items-center justify-center min-h-full gap-2 p-8 py-12">
